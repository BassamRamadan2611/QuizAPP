...
export class ExamComponent implements OnInit {
  ...
  constructor(private route:ActivatedRoute , private service:DoctorServiceService ,private auth :AuthService,
  ...
  getResult() {
    ...
    this.auth.updateStudent(this.user.userId , model).subscribe(res => {
      this.toaster.success("  The Result Registered Successfully")
    })
